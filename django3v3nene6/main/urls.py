...
for i in os.listdir(mainDir):
    if i not in excludeList and i[-5:] == "_v.py":
        ...
        if tableName.lower()=="fangyuanxinxi":
            urlpatterns.extend(
                  [
                  path(r'{}/value/<xColumnName>/<yColumnName>/<timeStatType>'.format(tableName.lower()),
                       eval("{}_v.{}_value".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "zulindingdan":
            urlpatterns.extend(
                [
                    path(r'{}/shBatch'.format(tableName.lower()),
                         eval("{}_v.{}_shBatch".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "zhaopinxinxi":
            urlpatterns.extend(
                [
                    path(r'{}/shBatch'.format(tableName.lower()),
                         eval("{}_v.{}_shBatch".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower()=="toudijianli":
            urlpatterns.extend(
                  [
                  path(r'{}/value/<xColumnName>/<yColumnName>/<timeStatType>'.format(tableName.lower()),
                       eval("{}_v.{}_value".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "toudijianli":
            urlpatterns.extend(
                [
                    path(r'{}/typeStat/xingbie/zhiweimingcheng'.format(tableName.lower()),
                         eval("{}_v.{}_typeStat_xingbie_zhiweimingcheng".format(tableName.capitalize(), tableName.lower()))),
                ]
            )
        if tableName.lower() == "toudijianli":
            urlpatterns.extend(
        ...
        if tableName.lower()=="luqutongzhi":
            urlpatterns.extend(
                  [
                  path(r'{}/value/<xColumnName>/<yColumnName>/<timeStatType>'.format(tableName.lower()),
                       eval("{}_v.{}_value".format(tableName.capitalize(), tableName.lower()))),
...
#消息
        if tableName.lower() == "chatmessage":
            urlpatterns.extend(
                       [
                        path(r'{}/mlist'.format(tableName.lower()),eval("{}_v.{}_mlist".format(tableName.capitalize(), tableName.lower()))),
                       ]
                   )
        if tableName.lower() == "chatmessage":
            urlpatterns.extend(
...
#好友
        if tableName.lower() == "friend":
            urlpatterns.extend(
                       [
                        path(r'{}/page2'.format(tableName.lower()),eval("{}_v.{}_page2".format(tableName.capitalize(), tableName.lower()))),
                       ]
                   )
        if tableName.lower() == "friend":
            urlpatterns.extend(
        ...
        if tableName.lower() == "discussfangyuanxinxi":
            urlpatterns.extend(
                [
                    path(r'{}/security'.format(tableName.lower()),
                         eval("{}_v.{}_security".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "discussjiuyezhidao":
            urlpatterns.extend(
                [
                    path(r'{}/security'.format(tableName.lower()),
                         eval("{}_v.{}_security".format(tableName.capitalize(), tableName.lower()))),
